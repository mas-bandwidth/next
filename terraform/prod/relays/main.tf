...
locals {
  ...
  google_relays = {
    ...
    */
    ...
    "google.osaka.3" = {
      datacenter_name = "google.osaka.3"
      type            = "n2-highcpu-2"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 80
    },
    */
    ...
    "google.seoul.3" = {
      datacenter_name = "google.seoul.3"
      type            = "n2-highcpu-2"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 80
    },
    */
    ...
    "google.taiwan.3" = {
      datacenter_name = "google.taiwan.3"
      type            = "n2-highcpu-2"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 80
    },
    */
    ...
    "google.warsaw.1" = {
      datacenter_name = "google.warsaw.1"
      type            = "n2-highcpu-2"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 80
    },
    ...
    */
    ...
    "google.melbourne.3" = {
      datacenter_name = "google.melbourne.3"
      type            = "n2-highcpu-2"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 80
    },
    ...
    */
    ...
    "google.saopaulo.1" = {
      ...
      type            = "e2-highcpu-2" # "c2-standard-4"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 43
    },
    ...
    */
    ...
    "google.dallas.1" = {
      ...
      type            = "e2-highcpu-2" # "c3-standard-4"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 43
    },
    ...
    */
    ...
    "google.doha.1" = {
      ...
      type            = "e2-highcpu-2" # "c3-highmem-4"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 43
    },
    ...
    "google.doha.3" = {
      ...
      type            = "e2-highcpu-2" # "e2-standard-8"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 43
    },
    ...
    "google.telaviv.1" = {
      ...
      type            = "e2-highcpu-2" # "c4-highmem-4"
      image           = "ubuntu-os-cloud/ubuntu-minimal-2204-lts"
      mrc             = 43
    },
