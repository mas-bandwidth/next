...
// SerializeAddress serializes a UDP address over a goserialize stream. goserialize is the
...
//
// Wire format (matches the pre-goserialize encoding and the C++ SDK): a 2-bit address
